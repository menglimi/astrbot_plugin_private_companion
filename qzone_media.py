# -*- coding: utf-8 -*-
"""QQ Zone image handling, upload transport, and publish request execution."""
...
__all__ = (
    ...
    "QZONE_PUBLISH_URL",
    "QZONE_REMOTE_IMAGE_MAX_BYTES",
    "QZONE_UNSAFE_MEDIA_HOSTS",
...
class QzoneMediaMixin(QzoneAuthMixin):
    """Image acquisition, upload, and QQ Zone publishing transport helpers."""
    ...
    async def _publish_qzone_text(
        ...
        async def publish_once(candidates: list[str]) -> dict[str, Any]:
            ...
            verified_tid = (
                _single_line(verification.get("tid"), 120)
            ...
            result = {
                ...
                "tid": verified_tid or str(getattr(post, "tid", "") or ""),
