...
def _initialize_core_and_relationship_config(self: Any, c: Any) -> None:
    ...
    self.adult_content_require_owner = self._cfg_bool(c, "adult_content_require_owner", True)
    ...
    self.adult_content_require_private_chat = self._cfg_bool(c, "adult_content_require_private_chat", True)
