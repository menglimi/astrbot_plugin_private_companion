...
| `review`（被动/主动审查） | review_and_group | enable_passive_response_review（兼容旧）、enable_proactive_message_review、smart_silence、passive_review_mode/strength、proactive_review_mode/strength + 阈值、passive_topic_suppression |
