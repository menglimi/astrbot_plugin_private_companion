...
def test_plugin_package_contains_complete_runtime_tree(tmp_path: Path) -> None:
    ...
    required = {
        ...
        f"{ARCHIVE_ROOT}/page_backend/__init__.py",
        f"{ARCHIVE_ROOT}/page_backend/backups.py",
        f"{ARCHIVE_ROOT}/page_backend/logs.py",
        f"{ARCHIVE_ROOT}/page_backend/routing.py",
        f"{ARCHIVE_ROOT}/page_backend/validation.py",
