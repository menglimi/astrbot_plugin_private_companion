...
class CommandHandlersMixin:
    ...
    def _companion_manual_setting_snapshot(self) -> list[str]:
        ...
        return [
            ...
            f"被动回复复核：{self._feature_on_text(runtime_persona_setting(self, 'enable_passive_response_review', runtime_persona_setting(self, 'enable_response_self_review', True)))}，模式 {runtime_persona_setting(self, 'passive_review_mode', runtime_persona_setting(self, 'response_review_mode', 'severe_only'))}，强度 {runtime_persona_setting(self, 'passive_review_strength', 'lenient')}，长度阈值 {runtime_persona_setting(self, 'response_review_max_chars', 260)} 字；内部标签清理：{self._feature_on_text(runtime_persona_setting(self, 'enable_framework_error_leak_guard', True))}",
    ...
    def _companion_manual_config_specs(self) -> dict[str, dict[str, Any]]:
        return {
            ...
            "enable_framework_error_leak_guard": {"type": "bool", "label": "内部标签清理"},
    ...
    def _companion_manual_config_display_meta(self) -> dict[str, dict[str, str]]:
        return {
            ...
            "enable_framework_error_leak_guard": {"label": "内部标签清理", "location": "拓展页 -> 功能开关 -> 通用能力 -> 内部标签清理"},
    ...
    def _companion_manual_config_location(self, key: str) -> str:
        ...
        locations = {
            ...
            "enable_framework_error_leak_guard": "拓展页 -> 功能开关 -> 通用能力 -> 内部标签清理",
    ...
    def _companion_manual_config_aliases(self) -> dict[str, str]:
        aliases = {
            ...
            "内部标签清理": "enable_framework_error_leak_guard",
            "标签清理": "enable_framework_error_leak_guard",
